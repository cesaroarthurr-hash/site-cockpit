                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="col-span-2 bg-white rounded-xl border border-gray-100 p-4 shadow-sm">
                    ...
                    <div className="space-y-2">
                      {[
                        { name: "M. Bernard", time: "09:00 – 10:30", status: "Terminée", ok: true },
                        { name: "Mme Dupont", time: "10:00 – 11:00", status: "En cours", ok: true },
                        { name: "M. Martin", time: "11:30 – 13:00", status: "Alerte", ok: false },
                        { name: "Mme Leroy", time: "14:00 – 15:30", status: "Planifiée", ok: true },
                      ].map((row, i) => (
